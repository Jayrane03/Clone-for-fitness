...
<body class="bg_blog">
    ...
    <h1>Our Blogs and Reviews</h1>
    <!-- about  -->
    <div class="blogContainer">
        <!-- <h1>Blogs By Jay - The Coder</h1>  -->
        <div class="blogitem">
            <h2>Hustle For Muscle !</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus imperdiet, nulla et dictum interdum,
                nisi lorem egestas vitae scel<span class="dots">...</span><span class="more">erisque enim ligula
            ...
            <button onclick="readMore()"id="myBtn" class="buttons bg_btn btn bg-btn ">Read more</button>
        </div>
        <div class="blogitem">
            <h2>Workout Is My Passion</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus imperdiet, nulla et dictum interdum,
                nisi lorem egestas vitae scel<span class="dots">...</span><span class="more">erisque enim ligula venenatis
                    dolor. Maecenas nisl est, ultrices nec congue eget, auctor vitae massa. Fusce luctus vestibulum
                    augue ut aliquet. Nunc sagittis dictum nisi, sed ullamcorper ipsum dignissim ac. In at libero sed
                    nunc venenatis imperdiet sed ornare turpis. Donec vitae dui eget tellus gravida venenatis. Integer
                    fringilla congue eros non fermentum. Sed dapibus pulvinar nibh tempor porta.</span></p>

            <button class="buttons bg_btn btn ">Read more</button>
        </div>
        <div class="blogitem">
            <h2>Train Daily</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus imperdiet, nulla et dictum interdum,
        ...
        <div class="blogitem">
            ...
            <button onclick="readMore()" class="buttons bg_btn btn ">Read more</button>
        </div>
    ...
    <section class="footer">
        <h4>About Us</h4>
        <p>At THE GYM, we’re about real fitness. <br> Our no-nonsense, results-driven culture was built on a history
            rooted in weightlifting</p>
        <div class="icons">
    ...
    <script>
        ...
        function readMore() {
            ...
            const btnText = document.getElementsByClassName("bg-btn");
